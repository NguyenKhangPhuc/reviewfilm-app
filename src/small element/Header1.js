...
function Header1() {
    ...
    const menu1 = [{ content: 'About us', address: 'Homeaboutus' }, { content: 'Content', address: 'Homecontent' }]
    const menu2 = [{ content2: 'Recommended', address: 'Recommendedmovie' }, { content2: 'Most rated', address: 'Mostratedmovie' }, { content2: 'Most popular' }, { content2: 'Common' }]
    ...
    return (
        <div className='headercenter'>
            ...
            <div className='center'>
                ...
                <div className='menu'>
                <div className='introducetext1'>One of the best web reviewfilm in the world #100</div>
